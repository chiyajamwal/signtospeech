...
while True:
    ...
    if interrupt & 0xFF == ord('h'):
        cv2.imwrite(os.path.join(directory+'hello/'+str(count['h']))+'.jpg',frame)  
    if interrupt & 0xFF == ord('t'):
        cv2.imwrite(os.path.join(directory+'thankyou/'+str(count['t']))+'.jpg',frame)    
    if interrupt & 0xFF == ord('p'):
        cv2.imwrite(os.path.join(directory+'please/'+str(count['p']))+'.jpg',frame) 
    if interrupt & 0xFF == ord('y'):
        cv2.imwrite(os.path.join(directory+'yes/'+str(count['y']))+'.jpg',frame)
    if interrupt & 0xFF == ord('n'):
        cv2.imwrite(os.path.join(directory+'no/'+str(count['n']))+'.jpg',frame)
